	...
	<nav class="navbar navbar-inverse navbar-fixed-top" style="height: 80px;">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Elearning</h1>
			</div>
...
$q="select * from lessos where lesson_name='$lesson_name'";
...
while ($res=mysqli_fetch_array($result)) {
  ?>
  			...
  			<input type="hidden" name="txt1" value="<?php echo $res['lesson_id'] ?>">
			<button  style="background-color: transparent;border: none;text-align:left;color: white;"><li style="width: 300px;"><?php echo $res['lesson_name']; ?></li></button>
