        ...
        <ul class="navbar-nav pl-5 custom-nav">
          <li class="nav-item custom-nav-item"><a href="index.php" class="nav-link">Home</a></li>
           <li class="nav-item custom-nav-item"><a href="courses.php" class="nav-link">Courses</a></li>
            <li class="nav-item custom-nav-item"><a href="interview.php" class="nav-link">Interview Questions</a></li>
          ...
          <?php 
              ...
              if (isset($_SESSION['is_login'])){
                echo '<li class="nav-item custom-nav-item"><a href="student/studentProfile.php" class="nav-link">My Profile</a></li> <li class="nav-item custom-nav-item"><a href="logout.php" class="nav-link">Logout</a></li>
                     <li class="nav-item custom-nav-item"><a href="Student/myCourse.php" class="nav-link">MyCourses</a></li>
                       <li class="nav-item custom-nav-item"><a href="Student/myinterview.php" class="nav-link">MyInterview Questions</a></li>';
              } else {
