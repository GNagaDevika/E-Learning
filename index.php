...
?>  
    ...
    <div class="container-fluid bg-danger txt-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          ...
          <div class="col-sm">
            <h5><i class="fas fa-users mr-3"></i>Student Friendly</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-keyboard mr-3"></i> Lifetime Access</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-smile mr-3"></i>Free courses</h5>
          </div>
        </div>
    </div> <!-- End Text Banner -->
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>E-learning offers content for the students to enhance the quality of learning by organizing free courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
            <a class="text-dark" href="#">Web Development</a><br />
            <a class="text-dark" href="#">Programming</a><br />
            <a class="text-dark" href="#">Database</a><br />
            <a class="text-dark" href="#">Web Designing</a><br />
          </div>
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>E-Learning Ltd<br>
Near B.V.Raju Marg<br>
